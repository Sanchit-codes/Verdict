...
if TYPE_CHECKING:
    ...
    try:
        ...
        pass
    try:
        from verdict.core.decision import GuardDecision  # noqa: F811
    except ImportError:
        pass
...
class GuardTrace(BaseModel):
    ...
    Attributes:
        ...
        name: Fixed value "verdict_validation" for Langfuse compatibility
