...
Typical usage:
    hguard eval --dataset halubench --policy rag_strict --output results.json
...
def eval(
    ...
    Examples:
        hguard eval --dataset demo --policy default
        hguard eval --dataset halubench --policy rag_strict --output results.json
    """
...
def benchmark(
    ...
    Examples:
        hguard benchmark --requests 100 --concurrency 5
        hguard benchmark --requests 1000 --concurrency 10 --policy rag_strict --output bench.json
    """
